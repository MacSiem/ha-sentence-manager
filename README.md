...
Manage voice command sentences for Home Assistant Assist
...
### Manual
1. Download `ha-sentence-manager.js` from this repository
2. Copy to `/config/www/community/ha-sentence-manager/`
