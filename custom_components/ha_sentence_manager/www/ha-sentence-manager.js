...
// v5.0: persistent application data is integration-backed rather than browser-global.
...
const HA_SENTENCE_MANAGER_BENTO_CSS = `
/* ═══════════════════════════════════════════════
...
class HASentenceManager extends HTMLElement {
  ...
  getStyles() {
    return `
      <style>${HA_SENTENCE_MANAGER_BENTO_CSS}
